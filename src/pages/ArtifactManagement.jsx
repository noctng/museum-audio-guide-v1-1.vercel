...
export default function ArtifactManagementPage() {
  ...
  const initialFormData = {
    artifact_code: '',
    image_url: '',
    title_en: '', title_vi: '', title_zh: '', title_ru: '', title_ko: '', title_ja: '', title_fr: '', title_de: '', title_es: '',
    desc_en: '', desc_vi: '', desc_zh: '', desc_ru: '', desc_ko: '', desc_ja: '', desc_fr: '', desc_de: '', desc_es: '',
    audio_en: '', audio_vi: '', audio_zh: '', audio_ru: '', audio_ko: '', audio_ja: '', audio_fr: '', audio_de: '', audio_es: '',
  };
  ...
  const handleEditClick = (artifact) => {
    ...
    setFormData({
      ...
      title_ko: artifact.title?.ko || '', title_ja: artifact.title?.ja || '', title_fr: artifact.title?.fr || '', title_de: artifact.title?.de || '', title_es: artifact.title?.es || '',
      ...
      desc_ko: artifact.description?.ko || '', desc_ja: artifact.description?.ja || '', desc_fr: artifact.description?.fr || '', desc_de: artifact.description?.de || '', desc_es: artifact.description?.es || '',
      ...
      audio_ko: artifact.audio_urls?.ko || '', audio_ja: artifact.audio_urls?.ja || '', audio_fr: artifact.audio_urls?.fr || '', audio_de: artifact.audio_urls?.de || '', audio_es: artifact.audio_urls?.es || '',
    });
  ...
  const handleSubmit = async (e) => {
    ...
    const artifactData = {
      ...
      title: {
        ...
        ko: formData.title_ko, ru: formData.title_ru, ja: formData.title_ja, fr: formData.title_fr, de: formData.title_de, es: formData.title_es,
      },
      description: {
        en: formData.desc_en, vi: formData.desc_vi, zh: formData.desc_zh,
        ru: formData.desc_ru, ko: formData.desc_ko, ja: formData.desc_ja, fr: formData.desc_fr, de: formData.desc_de, es: formData.desc_es,
      },
      audio_urls: {
        en: formData.audio_en, vi: formData.audio_vi, zh: formData.audio_zh,
        ru: formData.audio_ru, ko: formData.audio_ko, ja: formData.audio_ja, fr: formData.audio_fr, de: formData.audio_de, es: formData.audio_es,
      }
    };
            ...
            <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="grid gap-4 py-4">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
                  ...
                  <Input name="title_es" placeholder="Español" value={formData.title_es} onChange={handleInputChange}/>
                </div>
                ...
                <div className='space-y-3'>
                  ...
                  <Textarea name="desc_es" placeholder="Español Description" value={formData.desc_es} onChange={handleInputChange}/>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
                  ...
                  <Input name="audio_es" placeholder="Español Audio URL" value={formData.audio_es} onChange={handleInputChange}/>
                </div>
